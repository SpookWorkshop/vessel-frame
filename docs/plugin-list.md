...
|-------------|------------|------|-------------|
| udp_message_source | Spook | Built In | For reading raw AIS data over UDP, for example a network source or aiscatcher output |
| serial_message_source | Spook | Built In | For reading AIS data over USB |
| daisy_message_source | Spook | [Github](https://github.com/SpookWorkshop/vessel-frame-plugins/tree/main/sources/daisy-message-source) | For reading AIS data over I2C from a dAISy Mini/FeatherWing |
| aisstreamio_message_source | Spook | [Github](https://github.com/SpookWorkshop/vessel-frame-plugins/tree/main/sources/aisstreamio-message-source) | Combined Source+Decoder for streaming from aisstream.io (requires API key) |
...
| Plugin Name | Created By | Link | Description |
|-------------|------------|------|-------------|
| udp-message-forwarder | Spook | [Github](https://github.com/SpookWorkshop/vessel-frame-plugins/tree/main/processors/udp-message-forwarder) | Forward raw AIS data to a UDP listener. This is the mechanism most data brokers (eg MarineTraffic, VesselFinder, AISHub etc) use for receiving data |
